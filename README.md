# Link
    ...
    https://docs.waves.tech/en/waves-node/how-to-install-a-node/how-to-install-a-node#system-requirements
    https://docs.waves.tech/en/waves-node/node-configuration#changing-node-parameters
    https://docs.waves.tech/en/waves-node/extensions/blockchain-updates#installation-via-deb-package
    https://docs.waves.tech/en/waves-node/extensions/grpc-server/#debugging-with-grpcurl
